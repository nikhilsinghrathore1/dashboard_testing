...
const FiltercompS:React.FC<val> = ({close}) => {
  return (
               <div className='absolute z-40 right-0 top-0 w-[100vw] h-full  bg-blue-800/10 backdrop-blur-[2px] flex items-center justify-end px-5'>
